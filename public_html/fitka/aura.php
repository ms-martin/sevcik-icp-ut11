...
<head>
  ...
  <link rel="stylesheet" href="aura.css" type="text/css"> </head>
  
<body>

<?php
if(isset($_SESSION["cennik"]) == FALSE) {
	$_SESSION["cennik"] = FALSE;
} 
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if(isset($_SESSION["cennik"])) {
		$_SESSION["cennik"] = !$_SESSION["cennik"];
	}
} else {
	$_SESSION["cennik"] = FALSE;
}
                        ...
                        <div id="carouselArchitecture" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner" role="listbox">
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="../images/fitka/kings.jpg" data-holder-rendered="true"> </div>
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="../images/fitka/uniq.jpg" data-holder-rendered="true"> </div>
                            <div class="carousel-item active">
                              <img class="d-block img-fluid" src="../images/fitka/aura.jpg" data-holder-rendered="true" height="" width="100%"> </div>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  <div class="py-5">
    <div class="container text-white">
      <div id="trener" class="row">
        <div class="align-self-center p-5 col-md-4 mx-auto">
          ...
          <div class="row">
		  <a class="btn btn-lg btn-primary" onclick="myFunction()" style="width:150px">Objdenať sa</a>
		  <script>
			function myFunction() {
				alert("Bol si objednaný na tréning!");
			}
		  </script>
		  <p class="p-1"> </p>
			<form method="post" action="aura.php#cenik">
				<button id="cenik" class="btn btn-lg btn-primary" type="submit" style="width:150px"> Cenník </button>
			</form>
		  </div>
  <?php if(isset($_SESSION["cennik"]) and $_SESSION["cennik"]): ?>
    <div class="container" style="position:absolute;right:0;top:92%;z-index:1000;">
      <div class="text-center mx-auto" style="width:330px;">
        <table class="table mx-auto text-dark" style="background-color:rgba(255,255,255,255);overflow: visible;">
			<thead>
			  <tr>
				<th>Typ cvičenia</th>
				<th></th>				
			...
			<tbody>
			  <tr>
				<td>Online poradca</td>
				<td>|</td>
				<td>12€/hod</td>
			  </tr>
			  <tr>
				<td>Skupinový tréning</td>
				<td>|</td>
				<td>15€/hod</td>
			  </tr>
			  <tr>
