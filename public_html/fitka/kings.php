...
<head>
  ...
  <link rel="stylesheet" href="kings.css" type="text/css"> </head>
                        ...
                        <div id="carouselArchitecture" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                              <img class="d-block img-fluid" src="../images/fitka/kings.jpg" data-holder-rendered="true" width="100%"> </div>
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="../images/fitka/aura.jpg" data-holder-rendered="true" width="100%"> </div>
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="../images/fitka/elam_foto1.jpg" data-holder-rendered="true" width="100%" height="400"> </div>
                          </div>
                        </div>
                      </div>
                    </div>
