...
$sql = "SELECT * FROM protein LIMIT 12";

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $searchExpr = test_input($_POST["search"]);
    if($searchExpr != '') $sql = "SELECT * FROM protein WHERE protein.name LIKE '%$searchExpr%' LIMIT 12";
}
      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col p-5 text-center">
            <div class="col-md-12">
				<form class="form-inline m-0 p-3" method="post" action="proteins.php">
		...
		?>
			<div class="col-md-4 p-3 d-flex align-items-stretch">
				<div class="card">
					...
					<img class="img-fluid"
						 src="../images/eshop/IMG_Proteins/<?php echo $GLOBALS["currRow"]["img_path"];?>.jpg"
						 alt="Card image">
                    ...
                    <a class="btn btn-primary btn-block" href="proteins.php?price=<?php echo $GLOBALS["currRow"]["price"];?>"><i
